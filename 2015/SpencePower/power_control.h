...
#define THIRTY_V_EX_REG     DDRE
#define THIRTY_V_EX_PORT    PORTE
#define THIRTY_V_EX_PIN     PRTE6
#define THIRTY_V_ARDUINO    6
#define TWELVE_V_REG		DDRB
#define TWELVE_V_PORT       PORTB
#define TWELVE_V_PIN        PRTB0
